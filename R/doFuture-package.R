...
#' controlled by \code{foreach()} option
#' \code{.options.future = list(scheduling = <value>)}.
...
#' The default value is \code{scheduling = 1.0}, unless option
#' \code{.options.multicore = list(preschedule = <logical>)} is set,
